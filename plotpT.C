...
void plotpT()
{
	...
	TFile *f1= TFile::Open("/Users/joshfrandsen/test/jetty/output/hpT_20_70.root");
	if (f1 ==0) cout<< "ERROR! File 1 didn't open" << endl;
	else cout << "File 1 Opened!" << endl;

	TFile *f2= TFile::Open("/Users/joshfrandsen/test/jetty/output/hpT_70_120.root");
	if (f2 ==0) cout<< "ERROR! File 2 didn't open" << endl;
	else cout << "File 2 Opened!" << endl;

	TFile *f3= TFile::Open("/Users/joshfrandsen/test/jetty/output/hpT_120_170.root");
	if (f3 ==0) cout<< "ERROR! File 3 didn't open" << endl;
	else cout << "File 3 Opened!" << endl;	

	TFile *f4= TFile::Open("/Users/joshfrandsen/test/jetty/output/hpT_170_220.root");
	...
	TH1F *h2 = (TH1F*)f2->Get("hpT");
	TH1F *h3 = (TH1F*)f3->Get("hpT");
	TH1F *h4 = (TH1F*)f4->Get("hpT");
